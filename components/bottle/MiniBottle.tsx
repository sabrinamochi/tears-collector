  ...
  return (
    ...
    >
      <motion.div
        ...
        onAnimationComplete={() => {
          if (gulping) setGulping(false);
        }}
      >
        <svg viewBox="0 0 120 108" width={120} height={108} overflow="visible">
          {/* Jar body */}
          <path
            d="M10 30 L10 108 Q10 108 108 108 Q110 108 110 108 L110 30 Z"
            fill="none"
          ...
          {/* Jar tint */}
          <path
            d="M12 32 L12 108 Q12 74 60 74 Q108 74 108 108 L108 32 Z"
            fill="var(--sad)"
            fillOpacity={0.05}
          />
